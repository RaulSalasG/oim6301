...
def _():
    ...
    tax=float(input('tax: '))
    print(f'The cost is: ${cost:.3f}. Total cost is ${cost+tax:.7f}')
    return (cost,)
...
@app.cell
def _():
    freight_charges = [16.75, 22.25, 25.00, 20.25, 36.25, 35.50, 24.25, 37.50, 16.75, 21.50]
    freight_charges
